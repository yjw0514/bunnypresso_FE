...
export default function OrderHistory() {
  ...
  return (
    <div className="h-screen p-4">
      <h3 className="mb-10 text-lg font-bold tex-center">나의 주문 내역</h3>
      <ul
        role="list"
        className="flex flex-col space-y-4 overflow-scroll divide-y pb-4 divide-gray-200 h-[80%] scrollbar-hide"
      >
        {isSuccess &&
